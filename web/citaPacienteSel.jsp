                                ...
                                <tbody>
                                    <c:forEach var="f" items="${list}">
                                        <tr>
                                            ...
                                            <td class="text-center">${f.doctor}</td>
                                            ...
                                            <td >
                                                <form name="form" action="PDF.jsp" target="_black">
                                                    <input type="hidden" name ="jasper" value="Reportes/Ficha_Constancia_Cita_Paciente.jasper" size="10"/>
                                            ...
                                            <td >
                                                <form action="Cita" method="post">
                                                    <input type="hidden" name="accion" value="DEL2"/>
                                                    <input type="hidden" name ="id" value="${paciente.getIdpacientes()}" size="10"/>
                                                    <input type="hidden" name ="id_cita" value="${f.idcita}" size="10"/>
                                                    <center><button type="submit"><i class="bi bi-trash"></i></button></center>
                                                </form>
                                            </td>
                                    <!--th>
                                        <input type="checkbox" name="id_upd" 
                                               value=""/>
                                    </th-->

                                    </tr>
                                </c:forEach>
                                <!--input type ="hidden" name="idX" id="idp"
                                               value=""/-->
                                </tbody>
                            </table>
