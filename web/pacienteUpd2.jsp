        ...
        <div class="d-flex">
            ...
            <div class="w-100">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" 
                                       data-toggle="dropdown" aria-expanded="false">
                                        ${paciente.getNombres_paciente()} ${paciente.getApellidos_paciente()}
                                    </a>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <h1 class="mt-2"> Modificar Mis Datos </h1> 
                            <form action="Paciente" method="post"> 
                                <input type="hidden" name="accion" value="UPD2"/>
                                <input type="hidden" name="idpacientes" value="${paciente.idpacientes}"/>
                                <input class="align-items-center" type="hidden" name="id"
                                                           value="${paciente.idpacientes}"/>
