        ...
        <main class="form-signin ">
            <form action="Login" method="POST">
                ...
                <div class="form-floating">
                    ...
                    <input type="password" autocomplete="off" class="form-control" id="floatingPassword" name="pass" placeholder="Password">
                </div>

                <button class="w-100 btn btn-lg btn-primary mt-4" type="submit"><i class="fas fa-sign-in-alt"></i>  Ingresar</button>

                <a class="w-100 btn btn-lg btn-primary mt-4" type="button" onclick="Registro();"><i class="fas fa-sign-in-alt"></i>  Registrate</a>
                <a class="w-100 btn btn-lg btn-primary mt-4" type="button" onclick="RecuperarPass();"> ¿Olvidaste tu contraseña?</a>
                <script>
