                            ...
                            <form action="Administrador" method="post"> 
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mt-4">
                                        Tipo de Documento:
                                        <select class="form-control" name="tipo_doc_administrador">
                                            <option class="form-control"  value="DNI"
                                                    <c:if test="${administrador.tipo_doc_administrador.equals('DNI')}">
                                                        selected
                                                    </c:if>>DNI</option>
                                            <option class="form-control" value="CARNET DE EXTRANJERIA" 
                                                    <c:if test="${administrador.tipo_doc_administrador.equals('CARNET DE EXTRANJERIA')}">
                                                        selected
                                                    </c:if>>CARNET DE EXTRANJERIA</option>
                                            <option class="form-control" value="C.C." 
                                                    <c:if test="${administrador.tipo_doc_administrador.equals('C.C.')}">
                                                        selected
                                                    </c:if>>C.C.</option>
                                        </select>
                                        <br/>
                                        Nro de Documento: 
                                        <input class="form-control" type="text" name="nro_doc_administrador"value="${administrador.nro_doc_administrador}"/>
                                        <br/>
                                        Nombre:
